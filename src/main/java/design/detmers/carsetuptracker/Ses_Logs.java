...
public class Ses_Logs {
    ...
    public Ses_Logs(int id, String date, int T_LFI, int T_LFM, int T_LFO, int P_LF, int T_RFI, int T_RFM, int T_RFO, int P_RF, int T_LRI, int T_LRM, int T_LRO, int P_LR, int T_RRI, int T_RRM, int T_RRO, int P_RR, String note)
    {
        this.id=id;
        this.date=date;
        this.LF[0]=T_LFI;
